...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public class MyTask2 extends AsyncTask<Void, Void, Void> {
        ...
        public MyTask2(String param) {
            this.Valutes = param;
        }

        @Override
        protected Void doInBackground(Void... voids) {
            connector = new SQLiteConnector(MainActivity.this, Valutes, 1); //контекст поточного Актівіті, назва бази, версія
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnCreate:
                MyTask2 mt2 = new MyTask2("Valutes");
                mt2.execute();//non blocking method
